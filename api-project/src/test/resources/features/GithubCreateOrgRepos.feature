...
Feature: Create organization repository
  ...
  Scenario: Create repository with valid org,token,name
    ...
    And header "Authorization" with value "Bearer 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"
  ...
  Scenario Outline: Create repository with valid and invalid scenarios
    ...
    Examples: 
      ...
      | RestAPITestingApril2022 | Bearer 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 | repo_july_13_03 | true    |                      |         201 |
      | RestAPITestingApril2022 | Bearer ghp_9999999                              | repo_july_13_03 | true    | repo from automation |         401 |
      | RestAPI3333333333332022 | Bearer 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 | repo_july_13_03 | true    | repo from automation |         404 |
      | RestAPITestingApril2022 | Bearer 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 | repo_july_13_03 | true    | repo from automation |         422 |
      | RestAPITestingApril2022 | Bearer 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 | repo_july_13_03 | true    | repo from automation |         403 |
